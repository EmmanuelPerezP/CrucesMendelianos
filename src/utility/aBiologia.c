...
// int main()
// {
        // **************tienen que crearse en la parte del codigo que se va a usar****************
//     string listaCaracteristicas[10] = {"A","B","C","D","E","F"}; // tienen que crearse en la parte del 
                                                                    // codigo que se va a usar
...
//     creaFenotipos(listaPadres,n,listaCaracteristicas,fenotiposDominantes,fenotiposRecesivos);
        ...
        // Esto es cuando se ocupa escribir en un archivo.
